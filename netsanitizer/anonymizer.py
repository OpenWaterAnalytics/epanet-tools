#!/usr/bin/python
##
## anonymizer <epanet-input-file> <anonymized-output-file> <map-output-file> <baseline-elevation>
##
...
if len(sys.argv) != 5:
  print "Usage: anonymizer <epanet-input-file> <anonymized-output-file> <map-output-file> <baseline-elevation>"
  sys.exit(1)
